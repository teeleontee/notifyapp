...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> CONTENT =
        createField(DSL.name("CONTENT"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.CHECKED_TIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> CHECKED_TIME =
        createField(DSL.name("CHECKED_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super Integer, ? super String, ? super String, ? super OffsetDateTime, ? extends U> from
    ) {
